...
//
//    // [API] 뉴스 승인하기
//    public Boolean approvalNotice(CustomUserDetails userDetails, Integer noticeId) throws Exception {
//        User user = userDetails.getUser();
...
//
//    // [API] 뉴스 거절하기
//    public Boolean rejectionNotice(CustomUserDetails userDetails, Integer noticeId) throws Exception {
//        User user = userDetails.getUser();
//        Notice notice = noticeRepository.findById(noticeId).orElseThrow();
//        notice.setStatus(2);
//        return true;
