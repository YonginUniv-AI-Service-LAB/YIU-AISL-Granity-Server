...
//    public ResponseEntity<Boolean> approvalNotice(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam(value = "id") Integer noticeId) throws Exception {
//        return new ResponseEntity<>(noticeService.approvalNotice(userDetails, noticeId), HttpStatus.OK);
//    }
//
//    // 뉴스 거절하기
//    @PutMapping(value = "/manager/notice/news/rejection")
//    public ResponseEntity<Boolean> rejectionNotice(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestParam(value = "id") Integer noticeId) throws Exception {
//        return new ResponseEntity<>(noticeService.rejectionNotice(userDetails, noticeId), HttpStatus.OK);
//    }
}
