    ...
    public SecurityFilterChain filterChain(final @NotNull HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/login", "/register", "/register/email", "/token/refresh", "/main", "/faq", "/major", "/major/history", "/major/professor", "/major/council", "/major/curriculum", "/major/lab", "/notice").permitAll()
